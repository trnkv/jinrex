...
urlpatterns = [
	...
	url(r'^get_excursion/(\d+)/change_confirmed_by_guide/$', views.change_confirmed_by_guide),
	url(r'^get_excursion/(\d+)/change_confirmed_by_incharge/$', views.change_confirmed_by_incharge),
